...
{
    [DataContract]
    public class SetOrderItemsAsConfirmedCommand
        : IRequest<bool>
    {
        [DataMember]
        ...
        public SetOrderItemsAsConfirmedCommand()
        {
            _orderItems = new List<OrderItemDto>();
        }

        public SetOrderItemsAsConfirmedCommand(IList<ProviderOrderItem> items, int orderId, string providerId) : this()
        {
